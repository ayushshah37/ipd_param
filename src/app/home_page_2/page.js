        ...
        (position) => {
          ...
          fetch('http://127.0.0.1:8000/location/checkzone/', {
            ...
            .then((data) => {
              ...
              setZone(data.status); // Set zone state
              // Set vehicle coordinates state using the vehicle coordinates from API response
              setVehicleCoordinates(data.vehicle_coord);
            })
            .catch((error) => {
    ...
    <>
      ...
      <section className="w-full py-12 lg:py-24">
        <div className=" mx-auto px-4 md:px-2">
          ...
          <Map additionalCoordinates={vehicleCoordinates}/>
            {zone && (
              <section className="w-full py-12 lg:py-24">
                <div className=" mx-auto px-4 md:px-2">
                  <div className="grid items-center gap-6 lg:grid-cols-[1fr_800px] lg:gap-12 xl:grid-cols-[1fr_800px]">
